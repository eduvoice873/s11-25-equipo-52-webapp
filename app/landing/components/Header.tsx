  ...
  return (
    <header className="bg-background shadow-lg py-4 fixed top-0 left-0 w-full z-50">
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <nav className="hidden md:flex gap-8 text-lg text-gray-700 font-semibold font-lato" aria-label="Navegación principal">
          <Link href="/#problema" className="hover:text-brand-light transition-colors">Problema</Link>
          <Link href="/#caracteristicas" className="hover:text-brand-light transition-colors">Características</Link>
          <Link href="/#api" className="hover:text-brand-light transition-colors">API</Link>
