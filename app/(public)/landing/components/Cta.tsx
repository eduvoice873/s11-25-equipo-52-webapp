  ...
  return (
    <section id="demo" className="py-24 bg-linear-to-br from-brand-blue via-[#104C8B] to-[#15326B] text-background relative overflow-hidden text-center">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <h2 className="text-4xl md:text-6xl font-black mb-6 font-nunito">
        ...
        <p className="text-blue-100 text-xl mb-12 max-w-3xl mx-auto font-lato">
          Únete a +200  instituciones que ya están usando EduVoice CMS para gestionar su social proof de
          forma profesional.
        </p>

        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <Link href="/signup" className="bg-brand-yellow text-brand-blue px-10 py-5 rounded-xl font-extrabold text-xl shadow-2xl transition-all duration-300 hover:bg-yellow-400 hover:scale-105">
